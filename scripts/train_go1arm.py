...
from go1_gym.envs.go1.w_arm.go1_arm_config import Go1ArmCfg, Go1ArmRunnerArgs
from go1_gym.envs.go1.w_arm import Go1ArmTrackingEasyEnv
...
def train_go1(args):
  ...
  Go1ArmCfg.env.num_envs = args.num_envs

  env = Go1ArmTrackingEasyEnv(sim_device=args.sim_device, headless=args.headless, cfg=Go1ArmCfg)

  # log the experiment parameters
  logger.log_params(AC_Args=vars(AC_Args), PPO_Args=vars(PPO_Args), Go1RunnerArgs=vars(Go1ArmRunnerArgs),
                    Go1Cfg=vars(Go1ArmCfg))
