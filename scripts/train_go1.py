...
from go1_gym.envs.go1.wo_arm import Go1TrackingEasyEnv
...
def train_go1(args):
  ...
  env = Go1TrackingEasyEnv(sim_device=args.sim_device, headless=args.headless, cfg=Go1Cfg)

  # log the experiment parameters
  # NOTE save parameters.pkl
  ...
  runner = Runner(env, runner_args=Go1RunnerArgs, run_name=args.run_name, device=f"cuda:{gpu_id}")
